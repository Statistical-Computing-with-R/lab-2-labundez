...
Because the p-value is indicated to be less than 0, which is significant, we reject the null hypothesis. At least one species has significantly different mean weight compared to the others.
